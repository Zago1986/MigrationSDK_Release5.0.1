    ...
    public class DataSourceProjectMapping : ContentMappingBase<IPublishableDataSource>
    {
            ...
            CancellationToken cancel)
        {
            ...
            if (_projectCache.TryGetProjectLocation(destProjectLuid, out var destProjectLocation))
            {
                ...
                _logger?.LogInformation("Data source '{DataSourceName}' mapped to destination project at {DestLocation}", 
            ...
            else
            {
                ...
                _logger?.LogWarning("Destination project {DestProjectLuid} not found in cache for data source {DataSourceName}. Using LUID-based location.", 
